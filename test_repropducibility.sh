...
python qa_subgraph_sampling.py --dataset mquake --hops n --sampling-method neighborhood --seed 30 > /tmp/neighborhood_1.txt
python qa_subgraph_sampling.py --dataset mquake --hops n --sampling-method neighborhood --seed 30 > /tmp/neighborhood_2.txt
